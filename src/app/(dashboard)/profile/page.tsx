            ...
            <div className="w-full md:w-80 bg-white border-r border-gray-200 p-6 flex flex-col flex-shrink-0 overflow-y-auto">
              ...
              <div className="flex flex-col space-y-1">
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === "personal" ? "bg-indigo-700 text-white shadow-md" : "text-gray-600 hover:bg-gray-100"}`}
                >
                  <User size={18} /> Personal Identity
                </button>
                <button
                  onClick={() => setActiveTab("contact")}
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === "contact" ? "bg-indigo-700 text-white shadow-md" : "text-gray-600 hover:bg-gray-100"}`}
                >
                  <Globe size={18} /> Presence & Contact
                </button>
                <button
                  onClick={() => setActiveTab("expertise")}
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === "expertise" ? "bg-indigo-700 text-white shadow-md" : "text-gray-600 hover:bg-gray-100"}`}
                >
                  <Briefcase size={18} /> Expertise & Skills
                </button>
                <button
                  onClick={() => setActiveTab("security")}
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === "security" ? "bg-indigo-700 text-white shadow-md" : "text-gray-600 hover:bg-gray-100"}`}
                >
            ...
            <div className="flex-1 flex flex-col bg-gray-50 overflow-hidden relative">
              <div className="sticky top-0 bg-gray-50/90 backdrop-blur-md z-10 px-8 py-6 border-b border-gray-200 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Manage your academic identity and research presence.
                  </p>
                </div>
                <Button
              ...
              <div className="flex-1 overflow-y-auto px-8 py-6 space-y-6">
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all text-sm"
                      />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-600 mb-2">
                  ...
                  <div>
                    <label className="block text-sm text-gray-600 mb-2">
                      Bio & Research Specialization
                    </label>
                    <textarea
                      rows={4}
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all text-sm resize-y"
                      defaultValue="Mahasiswa Teknologi Informasi ITS yang berfokus pada inovasi dan pengembangan teknologi informasi."
                    ></textarea>
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-200 focus:border-indigo-500 outline-none text-sm"
                        />
                      </div>
                    </div>
                    <div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2 items-center">
                    {["Frontend", "Next.js", "Tailwind CSS", "React"].map(
                      (skill) => (
                        <span
                          key={skill}
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-full text-sm font-medium border border-indigo-100"
                        >
                          {skill}
              ...
              <div className="sticky bottom-0 bg-white border-t border-gray-200 px-8 py-5 flex items-center justify-end gap-4 z-10">
                ...
                <Button
                  onClick={handleSaveProfile}
                  variant="primary"
                  className="bg-indigo-700 hover:bg-indigo-800 px-8"
                >
                  Save Profile
                </Button>
              </div>
