            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
              ...
              <section className="lg:col-span-2 rounded-md border border-slate-200 bg-white p-6 shadow-xs">
                <div className="flex flex-col items-center justify-center gap-6 md:flex-row">
                  {/* avatar */}
                  <div className="h-28 w-28 shrink-0 rounded-md bg-slate-200" />
              ...
              <section className="rounded-md border border-slate-200 bg-white p-6 shadow-xs">
                <div className="flex h-full flex-col items-center justify-center text-center">
                  ...
                  <div className="mt-4 h-14 w-24 rounded bg-slate-200" />
                    ...
                    <div className="space-y-4">
                      {Array.from({ length: 3 }).map((_, i) => (
                        ...
                        >
                          ...
                          {/* review */}
                          <div className="mt-4 rounded-md border border-slate-100 bg-slate-50 px-4 py-3 space-y-2">
                            <div className="h-4 w-full rounded bg-slate-200" />
                            <div className="h-4 w-full rounded bg-slate-200" />
